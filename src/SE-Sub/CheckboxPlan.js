...
class CheckboxPlan extends Component {
    state = {
        currentPage: 1,
        todosPerPage: 10,
        isChecked: false,
                ...
                <table>
                    ...
                    </tr>
                    {
                        currentTodos.map((option_element, index) => {
                            ...
                            return (
                                <tr>
                                    <td><input type="checkbox" value={option_element.first_name+" "+option_element.last_name} id='check'
                                        // amount={true}
